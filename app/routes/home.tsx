  ...
  return (
    <div className=" container px-40 mx-auto bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Discover Every <span className="text-indigo-600">Country</span> in the World
            </h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <button className="bg-indigo-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-indigo-700 transition-all hover:scale-105">
                Start Exploring →
              </button>
              <button className="border-2 border-gray-200 px-8 py-4 rounded-xl font-semibold hover:border-indigo-600 hover:text-indigo-600 transition-all">
                View Statistics
              </button>
            </div>
          </div>
          <div className="flex-1 relative">
            ...
            <div className="grid grid-cols-2 gap-4 p-4">
              ...
              <div className="space-y-4 pt-8">
                <div className="transform rotate-6 hover:rotate-0 transition-all">
                  <img 
                    src="https://images.unsplash.com/photo-1531257240678-d5b1922e672d?q=80&w=1974&auto=format&fit=crop" 
                    alt="Asia"
                    className="rounded-2xl h-64 w-full object-cover shadow-lg hover:shadow-xl transition-all"
                  />
                </div>
      ...
      <section className="container mx-auto px-4 mt-20 pb-24">
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-8 md:p-12">
