...
export default function Home() {
  return (
    <div className="container px-40 mx-auto bg-white dark:bg-gray-900">
      <section className="container mx-auto px-4 pt-12">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              Discover Every <span className="text-blue-600 dark:text-blue-400">Country</span> in the World
            </h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <button className="border-2 border-gray-200 dark:border-gray-700 px-8 py-4 rounded-xl font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">
                View Statistics
              </button>
            </div>
          </div>
          <div className="flex-1 relative">
            <div className="absolute -z-10 top-0 right-0 w-72 h-72 bg-indigo-100 dark:bg-indigo-900 rounded-full blur-3xl opacity-30"></div>
      ...
      <section className="container mx-auto px-4 mt-20 pb-24">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-3xl p-8 md:p-12">
